...
Estas herramientas también se equivocan: varias de las sugerencias que recibí eran plausibles y no
funcionaban, así que hay que comprobar siempre lo que proponen. Por eso contrasté las cinco métricas
con implementaciones escritas por mí en lugar de fiarme sin más de la biblioteca. Se mencionan aquí
con el mismo criterio que el editor de código o el sistema de control de versiones: son herramientas
que he usado.
