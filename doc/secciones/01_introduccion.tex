...
\begin{figure}[H]
	...
	\end{tikzpicture}
	\caption{Ejemplo de grafo ponderado: los nodos ($R_i$) representan regiones cerebrales y las
...
acceda desde cualquier navegador moderno, sin tener que instalar nada, y que le permita visualizar y
explorar redes cerebrales de forma inmediata, manteniendo un equilibrio entre fidelidad de los
...
análisis de las redes se realizan en un servicio de servidor; de este modo la herramienta puede
...
Además de estas dos referencias web, existen potentes herramientas de escritorio como
...
inconveniente es que depende de MATLAB, un entorno comercial. Igualmente existen herramientas
genéricas de análisis de grafos, como \textbf{Gephi}~\cite{gephi}, muy potentes en métricas y
...
\begin{itemize}
	...
	\item \textbf{Capítulo 5 --- Manual de instalación.} Detalla los requisitos previos y el
		procedimiento de instalación y lanzamiento de la aplicación mediante contenedores.
	\item \textbf{Capítulo 6 --- Manual de usuario.} Explica cómo utilizar la aplicación una vez
		desplegada.
