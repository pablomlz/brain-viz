...
2  & El sistema muestra una red por defecto ya renderizada y la lista de redes disponibles. \\ \hline
...
\textbf{Excepciones} & La red seleccionada no existe o sus ficheros están dañados. \\ \hline
...
2 & El sistema actualiza la cámara en tiempo real sin tirones. \\ \hline
...
\rowcolor[gray]{0.88}\multicolumn{2}{|c|}{\textbf{Secuencia}} \\ \hline
\textbf{Paso} & \textbf{Acción} \\ \hline
1 & El usuario pulsa ``salir''. \\ \hline
...
\rowcolor[gray]{0.88}\multicolumn{2}{|c|}{\textbf{Secuencia}} \\ \hline
\textbf{Paso} & \textbf{Acción} \\ \hline
1  & El investigador selecciona ``cargar una red''. \\ \hline
...
\rowcolor[gray]{0.88}\multicolumn{2}{|c|}{\textbf{Secuencia}} \\ \hline
\textbf{Paso} & \textbf{Acción} \\ \hline
1  & El investigador abre la sección ``mis redes''. \\ \hline
...
\rowcolor[gray]{0.88}\multicolumn{2}{|c|}{\textbf{Secuencia}} \\ \hline
\textbf{Paso} & \textbf{Acción} \\ \hline
1 & El investigador localiza la red en el catálogo. \\ \hline
2 & El sistema ofrece la descarga en cada uno de los formatos disponibles. \\ \hline
3 & El investigador elige el formato que necesita. \\ \hline
