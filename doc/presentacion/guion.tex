...
sprint es lo que están viendo: el mismo grafo, con el mismo encuadre, leído de cuatro formas. En la
primera el color dice dónde está cada región, que es la vista anatómica. En las otras tres el color
y el tamaño representan una métrica: el grado, que es cuántas conexiones tiene; la intermediación,
que señala los puntos de paso; y la cercanía, que dice cómo de bien situada está. De un vistazo se
identifica lo que sobre una tabla de noventa filas no se vería. La respuesta está en la escena. \pausa
