...
sprint es lo que están viendo: es el mismo grafo, con el mismo encuadre, leído de dos formas. A la
izquierda el color dice dónde está cada región, que es la vista anatómica. A la derecha el color y
el tamaño representan la intermediación, y de un vistazo se identifica qué regiones son los puntos
de paso de la red. La respuesta está en la escena, no en una tabla. \pausa
